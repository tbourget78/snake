window.onload = function () {
  ...
  function init() {
    ...
    canvas.style.border = "25px solid grey";
  ...
  function Apple(position) {
    ...
    this.setNewPosition = function () {
      var neawX = Math.round(Math.random() * (widthInBlocks - 1));
      var neawY = Math.round(Math.random() * (heightInBlocks - 1));
      this.position = [neawX, neawY];
    };
